			...
			<fieldset>
				...
				<div class="form-group">
					<label class='control-label col-lg-2 col-lg-2' for="bookNo">
						<spring:message code='spring.addProduct.form.productNo.label' />
					</label>
					<div class='col-lg-10'>
				...
				<div class="form-group">
					<label class='control-label col-lg-2 col-lg-2' for="companyId">
						<spring:message code='spring.addProduct.form.productCompany.label' />
					</label>
					<div class='col-lg-10'>
...
<!-- 				<div class="form-group"> -->
<!-- 					<label class='control-label col-lg-2 col-lg-2' for="cellphoneId"> -->
<!-- 						手機顏色 -->
<!-- 					</label> -->
<!-- 					<div class='col-lg-10'> -->
<%-- 						<form:select path="cellphoneId"> --%>
<%-- 							<form:option value="-1"> --%>
<!-- 							手機顏色 -->
<%-- 							</form:option> --%>
<%-- 							<form:options items="${cellphoneList}" /> --%>
<%-- 						</form:select> --%>
<!-- 					</div> -->
<!-- 				</div> -->
				<div class="form-group">
