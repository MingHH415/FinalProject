	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
							...
							<div class="thumbnail" style="width: 320px; height: 340px">
								...
								<div class="caption">
									<p style='text-align: center'>
										<b style='font-size: 25px'>${product.title}</b>
									</p>
									<p style='font-size: 15px;'>
										<b>廠牌&nbsp;:</b>&nbsp;&nbsp;${product.category}
									</p>
									<p style='font-size: 15px;'>
										<b>販售價格&nbsp;:</b>&nbsp;&nbsp;${product.price}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>庫存&nbsp;:</b>&nbsp;${product.stock}
									</p>
			...
			<section style="text-align: center">
				<a href="<spring:url value='//backproducts'/>"
					class="btn btn-primary"> <span
					class="glyphicon-info-sigh glyphicon"></span>1
				</a> <a href="<spring:url value='/backproducts1'/>"
					class="btn btn-primary"> <span
					class="glyphicon-info-sigh glyphicon"></span>2
				</a> <a href="<spring:url value='/backproducts2'/>"
					class="btn btn-primary"> <span
