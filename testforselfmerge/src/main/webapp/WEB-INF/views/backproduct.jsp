					...
					<!-- me art lab slider -->
							<div class='carousel-inner '>
								<div class='item active'>
									<img width='500px' height='637px' src="<c:url value='/getImage/${product.productId}'/>" alt='' data-zoom-image=" width='500px' height='637px'<c:url value='/getPicture/${product.productId}'/>" />
<%-- 									<img width='500px' height='637px'src="<c:url value='/getPicture/${product.productId}'/>" /> --%>
								</div>
								<div class='item'>
									<img width='500px' height='637px' src="<c:url value='/getImage/${product.productId}'/>" />
								</div>
