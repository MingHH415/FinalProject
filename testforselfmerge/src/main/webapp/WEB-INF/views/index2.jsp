								...
								<div class="media">
									...
									<div class="media-body">
										...
										<div class="cart-price">
											<span>購買數量EL</span> <span>單品價格EL</span>
										</div>
										<h5>
											<strong>此項總價EL(單品X購買數量)</strong>
										</h5>
									</div>
			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse text-center">
					<ul class="nav navbar-nav">
						...
						<!-- Home首頁 -->
						<li class="dropdown "><a href="index2.html">Home</a></li>
						<!-- / Home -->
						...
						<li class="dropdown "><a href="index.html">回產品後台</a></li>
						<!-- / 帳號 -->
			...
			<div id="home_slider"
				...
				<ul>
					...
					<li data-index="rs-73" data-thumb="images/slider/slider-1.png"
						...
						<!-- MAIN IMAGE --> <img src="images/slider/slider-1.png"
					...
					<li data-index="rs-74" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="images/slider/slider-3.png" alt=""
						data-bgposition="cover" data-bgfit="cover"
						data-bgrepeat="no-repeat" data-bgparallax="on" class="rev-slidebg"
...
<!-- ------------------------------------------------------------------------------------- -->
		<script type="text/javascript">
							...
							function count() {
								...
								document.getElementById("count").innerHTML = i;
								  ...
								  var JSONObj={"click":i,"adId":${advertise.adId}}
								        
								  $.ajax({
										type:"POST",
							...
							function count1() {
								...
								document.getElementById("count1").innerHTML = i1;
								  ...
								  var JSONObj={"click":i1,"adId":${advertise1.adId}}
								        
								  $.ajax({
										type:"POST",
										url:"${pageContext.request.contextPath}/countclick",
							...
							function count2() {
								...
								document.getElementById("count2").innerHTML = i2;
								  ...
								  var JSONObj={"click":i2,"adId":${advertise2.adId}}
								        
								  $.ajax({
										type:"POST",
										url:"${pageContext.request.contextPath}/countclick",
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<img class="img-responsive"
					...
					<div class="product-content">
						...
						<h4>
                        <a href="<spring:url value='/backproduct?id=${product.productId}' />">
						${product.title}</a>
						</h4>	<span id="adId">${advertise.adId}</span>
			...
			<div class="col-md-4">
				<div class="product-item">
					...
					<div class="product-content">
						...
						<h4>
						<a href="<spring:url value='/backproduct?id=${product1.productId}' />">
						${product1.title}</a>
						</h4>	<span id="adId">${advertise1.adId}</span>
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb" onclick="count2()">
						<img class="img-responsive"
					...
					<div class="product-content">
						...
						<h4>
						<a href="product-single.html">${product2.title}</a></h4>
