							...
							<div>
								<c:forEach var='advertise' items='${advertise}'>
									<div class="row" >
										...
										<div class="cell" data-title="budget">
											${advertise.budget}</div>
										<div class="cell" data-title="click">${advertise.click}
										</div>
										<div class="cell" data-title="price">${advertise.price}

										</div>
										<div class="cell" data-title="spend">${advertise.spend}
										</div>
