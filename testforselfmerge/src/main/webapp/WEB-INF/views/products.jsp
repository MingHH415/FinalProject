	              ...
	              <div class="row">
	                ...
	                <div class="col-lg-6 col-md-6 mb-sm-3">
	                	<ul>
							...
							<li><a href="<c:url value='/viewtocart'/>">Cart</a>
							</li>
...
<!-- 						商品 -->
						<img class="img-responsive" src="<c:url value='/getPicture/${product.productId}' />"  alt="product-img" />
...
<!-- 								/商品預覽 -->
								...
								<li>
			                        <a href="#愛心" ><i class="tf-ion-ios-heart"></i></a>
								</li>						
