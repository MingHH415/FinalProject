...
//			
	...
	public String insert(@ModelAttribute("id") Integer id, @ModelAttribute("cellBean") CellBean cell,
		...
		if (cell != null) {
			cell.setProductId(id);
			cell.setCellphoneId(id);
			String cd = cell.getCPU();
			if (cd != null) {
				service1.update(cell);
			} else {
				service1.addProduct2(cell);
			}
		}
		System.out.println("postcontrollercell: " + cell);
//		model.addAttribute("cellBean", cc);
		return "redirect:/products";
	}
...
//		model.addAttribute("cellBean", cc);
	...
	public String processAddNewProductForm(@ModelAttribute("productBean") ProductBean bb, BindingResult result,
		...
		return "redirect:/backaddProduct";
	}
	...
	public void whiteListing(WebDataBinder binder) {
		binder.setAllowedFields("author", "ProductNo", "category", "price", "title", "companyId", "productImage", "CPU",
				...
				"color", "stock", "productNo", "id", "productBean", "product", "cellBean");
	}
